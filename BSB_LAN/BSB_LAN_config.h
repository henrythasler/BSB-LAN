...
byte mqtt_broker_ip_addr[4] = {192,168,178,31}; // MQTT broker ip address. Please use commas instead of dots!!!
...
char MQTTTopicPrefix[32] = "home/energy/heater"; 	        // Optional: Choose the "topic" for MQTT messages here. In case of empty string, default topic name will be used
...
byte LoggingMode = 4; //CF_LOGMODE_SD_CARD | CF_LOGMODE_SD_CARD_24AVG | CF_LOGMODE_MQTT | CF_LOGMODE_UDP
